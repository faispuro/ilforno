      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-stone-800/80 pb-6">
          ...
          <div className="flex items-center gap-3 bg-stone-900/80 pl-1.5 pr-3 py-1.5 rounded-full border border-stone-800 backdrop-blur-sm">
            ...
            {/* Ficha tipo token de madera, en vez del contador en mono */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center py-6 min-h-115">
          ...
          {/* Columna Izquierda: Pizza sobre bandeja de madera (anillo integrado) */}
          <div className="lg:col-span-6 relative flex items-center justify-center order-2 lg:order-1">

            {/* Resplandor de brasas detrás de la bandeja */}
            ...
            {/* Sello / Badge 100% Casera */}
            <div className="absolute top-0 left-2 sm:left-8 z-30 bg-red-600 text-white font-black p-3.5 rounded-full shadow-2xl border-2 border-stone-900 -rotate-12 flex flex-col items-center justify-center w-18 h-18 text-center leading-none">
            ...
            {/* Bandeja de madera: anillo grueso alrededor de la foto, todo en una sola pieza */}
            <div
              className="relative z-10 w-68 h-68 sm:w-84 sm:h-84 lg:w-100 lg:h-100 rounded-full p-3 sm:p-4 shadow-2xl shrink-0"
              style={{
                background:
            ...
            >
              {/* Borde interno oscuro, separa la madera de la foto */}
            ...
            {/* Cartelito de precio, colgado como etiqueta de almacén */}
            <div className="absolute z-30 top-4 sm:top-6 right-0 sm:right-0 rotate-6">
          ...
          <div className="lg:col-span-6 space-y-6 text-center flex flex-col items-center justify-center order-1 lg:order-2">
            ...
            <div className="space-y-3 max-w-lg w-full">
              <div className="min-h-18 sm:min-h-30 flex items-center justify-center">
                <h3 className="text-4xl sm:text-6xl font-black uppercase tracking-tight text-stone-100 font-serif leading-none">
                  {currentPizza.name}
                </h3>
              </div>
              ...
              <div className="min-h-15 flex items-center justify-center">
                <p className="text-stone-400 text-sm sm:text-base leading-relaxed font-medium italic line-clamp-3 border-l-2 border-red-700/50 pl-4 text-left max-w-md">
