...
export const PizzaCarousel = ({ pizzas = [], onCustomizePizza }) => {
  ...
  // Duplicamos el array para generar el bucle continuo sin saltos visibles
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (scrollRef.current) {
        ...
        const maxScroll = container.scrollHeight ? (container.scrollWidth / 2) : 0;
    ...
    >
      ...
      >
        {extendedPizzas.map((pizza, index) => (
          ...
          >
            {/* Contenedor Circular de la Pizza / Overlay */}
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 flex items-center justify-center">
              
              {/* Aura de Resplandor/Fuego al Hover */}
              ...
              {/* Tag de Categoría flotante inicial */}
              {pizza.category && (
              ...
              {/* Overlay CIRCULAR al Hover (Estilo Ojo de Buey / Plato de Pizza) */}
            ...
            {/* Texto inferior por defecto (visible sin hover) */}
